...
import type { InstallmentGroupRepository, TransactionRepository } from "../../domain/repositories"
...
export class DeleteTransactionUseCase {
    ...
    async execute(userId: string, id: string): Promise<void> {
        ...
        if (transaction.installmentGroupId) {
            await this.repository.deleteByInstallmentGroup(userId, transaction.installmentGroupId)
            await this.installmentGroupRepository.delete(userId, transaction.installmentGroupId)
            return
        }

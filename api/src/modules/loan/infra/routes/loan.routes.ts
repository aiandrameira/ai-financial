...
export const loanRoutes = new Elysia({ prefix: "/loans", tags: ["Loans"] })
    ...
    .guard({ auth: true }, app =>
        app
            ...
            .get(
                "/:id/installments",
                ({ params, query, user }) => controller.findInstallments(user.id, params.id, query),
                {
            ...
            .post(
                ...
                ({ params, body, user }) => controller.payInstallment(user.id, params.id, params.installmentId, body),
                {
